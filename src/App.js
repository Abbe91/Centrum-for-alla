...
const MarketingPage = lazy(() =>
  import("./pages/InfoPages/MarketingPage")
);
...
const Bortforslingdodsbogoteborg = lazy(() => import("./blocks/Bortforslingdodsbogoteborg"))
        ...
        <Router>
          <Routes>
            ...
            <Route
              ...
              element={
                <Bortforslingdodsbogoteborg videoText={contentData?.videoText} />
              }
            />
            <Route
              path="bortforsling-dodsbo-ulricehamn"
              element={
                <Bortforslingdodsboulricehamn videoText={contentData?.videoText} />
              }
            />
